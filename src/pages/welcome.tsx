      ...
      <div id="smooth-content" className="relative z-10 min-h-screen flex flex-col items-center pt-6 text-[#1b1b18] lg:justify-center">
        ...
        <main className=" w-full pt-32 h-full max-w-full bg-[#131313] font-mono justify-center">
          ...
          <div className="flex items-center my-24 text-[#7af298] font-semibold justify-center gap-1">
            <a href="/projects" className="flex mx-auto items-center font-sans gap-2 border border-[#131313] bg-[#7af298] text-[#131313] p-2.5 px-7 rounded-3xl">
              View More Projects
            </a>
          </div>
          </div>
              ...
              {items.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <a href="/contact" className={`mt-4 text-[#7AF298] underline underline-offset-8 items-center gap-2 font-mono text-sm ${isActive ? "flex" : "text-[1px] mt-0 opacity-0 pointer-events-none"}`}>
                      Hire me
          ...
          <div className="max-w-340 p-8 mx-auto flex flex-col">
            <div className="flex flex-col lg:flex-row lg:justify-between items-start gap-6 py-8 rounded-2xl font-sans text-white">
              ...
              <div className="flex flex-col gap-8">
                ...
                <a href="/contact" className="flex mx-auto items-center font-sans gap-2 border border-[#131313] bg-[#7af298] text-[#131313] py-14 px-5 rounded-full">
                    Start Project
                </a>
              </div>
            </div>
