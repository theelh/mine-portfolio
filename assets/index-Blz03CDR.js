...
`,ff=16,JO=({reverseOrder:a,position:t="top-center",toastOptions:i,gutter:n,children:r,toasterId:l,containerStyle:c,containerClassName:u})=>{let{toasts:f,handlers:h}=MO(i,l);return N.createElement("div",{"data-rht-toaster":l||"",style:{position:"fixed",zIndex:9999,top:ff,left:ff,right:ff,bottom:ff,pointerEvents:"none",...c},className:u,onMouseEnter:h.startPause,onMouseLeave:h.endPause},f.map(g=>{let x=g.position||t,b=h.calculateOffset(g,{reverseOrder:a,gutter:n,defaultPosition:t}),v=ZO(x,b);return N.createElement(QO,{id:g.id,key:g.id,onHeightUpdate:h.updateHeight,className:g.visible?KO:"",style:v},g.type==="custom"?Zf(g.message,g):r?r(g):N.createElement(WO,{toast:g,position:x}))}))},eg=vi;class Su{constructor(t=0,i="Network Error"){this.status=t,this.text=i}}const t8=()=>{if(!(typeof localStorage>"u"))return{get:a=>Promise.resolve(localStorage.getItem(a)),set:(a,t)=>Promise.resolve(localStorage.setItem(a,t)),remove:a=>Promise.resolve(localStorage.removeItem(a))}},Ri={origin:"https://api.emailjs.com",blockHeadless:!1,storageProvider:t8()},Lm=a=>a?typeof a=="string"?{publicKey:a}:a.toString()==="[object Object]"?a:{}:{},e8=(a,t="https://api.emailjs.com")=>{if(!a)return;const i=Lm(a);Ri.publicKey=i.publicKey,Ri.blockHeadless=i.blockHeadless,Ri.storageProvider=i.storageProvider,Ri.blockList=i.blockList,Ri.limitRate=i.limitRate,Ri.origin=i.origin||t},Y5=async(a,t,i={})=>{const n=await fetch(Ri.origin+a,{method:"POST",headers:i,body:t}),r=await n.text(),l=new Su(n.status,r);if(n.ok)return l;throw l},G5=(a,t,i)=>{if(!a||typeof a!="string")throw"The public key is required. Visit https://dashboard.emailjs.com/admin/account";if(!t||typeof t!="string")throw"The service ID is required. Visit https://dashboard.emailjs.com/admin";if(!i||typeof i!="string")throw"The template ID is required. Visit https://dashboard.emailjs.com/admin/templates"},i8=a=>{if(a&&a.toString()!=="[object Object]")throw"The template params have to be the object. Visit https://www.emailjs.com/docs/sdk/send/"},q5=a=>a.webdriver||!a.languages||a.languages.length===0,V5=()=>new Su(451,"Unavailable For Headless Browser"),n8=(a,t)=>{if(!Array.isArray(a))throw"The BlockList list has to be an array";if(typeof t!="string")throw"The BlockList watchVariable has to be a string"},a8=a=>!a.list?.length||!a.watchVariable,s8=(a,t)=>a instanceof FormData?a.get(t):a[t],I5=(a,t)=>{if(a8(a))return!1;n8(a.list,a.watchVariable);const i=s8(t,a.watchVariable);return typeof i!="string"?!1:a.list.includes(i)},X5=()=>new Su(403,"Forbidden"),r8=(a,t)=>{if(typeof a!="number"||a<0)throw"The LimitRate throttle has to be a positive number";if(t&&typeof t!="string")throw"The LimitRate ID has to be a non-empty string"},l8=async(a,t,i)=>{const n=Number(await i.get(a)||0);return t-Date.now()+n},$5=async(a,t,i)=>{if(!t.throttle||!i)return!1;r8(t.throttle,t.id);const n=t.id||a;return await l8(n,t.throttle,i)>0?!0:(await i.set(n,Date.now().toString()),!1)},W5=()=>new Su(429,"Too Many Requests"),o8=async(a,t,i,n)=>{const r=Lm(n),l=r.publicKey||Ri.publicKey,c=r.blockHeadless||Ri.blockHeadless,u=r.storageProvider||Ri.storageProvider,f={...Ri.blockList,...r.blockList},h={...Ri.limitRate,...r.limitRate};return c&&q5(navigator)?Promise.reject(V5()):(G5(l,a,t),i8(i),i&&I5(f,i)?Promise.reject(X5()):await $5(location.pathname,h,u)?Promise.reject(W5()):Y5("/api/v1.0/email/send",JSON.stringify({lib_version:"4.4.1",user_id:l,service_id:a,template_id:t,template_params:i}),{"Content-type":"application/json"}))},c8=a=>{if(!a||a.nodeName!=="FORM")throw"The 3rd parameter is expected to be the HTML form element or the style selector of the form"},u8=a=>typeof a=="string"?document.querySelector(a):a,d8=async(a,t,i,n)=>{const r=Lm(n),l=r.publicKey||Ri.publicKey,c=r.blockHeadless||Ri.blockHeadless,u=Ri.storageProvider||r.storageProvider,f={...Ri.blockList,...r.blockList},h={...Ri.limitRate,...r.limitRate};if(c&&q5(navigator))return Promise.reject(V5());const g=u8(i);G5(l,a,t),c8(g);const x=new FormData(g);return I5(f,x)?Promise.reject(X5()):await $5(location.pathname,h,u)?Promise.reject(W5()):(x.append("lib_version","4.4.1"),x.append("service_id",a),x.append("template_id",t),x.append("user_id",l),Y5("/api/v1.0/email/send-form",x))},f8={init:e8,send:o8,sendForm:d8,EmailJSResponseStatus:Su};Di.registerPlugin(Ct,wu);function Q5(){Di.registerPlugin(Ct,Xn),N.useEffect(()=>{const h=Xn.create({wrapper:"#smooth-wrapper",content:"#smooth-content",smooth:1,effects:!0,smoothTouch:.1});return Ct.refresh(),()=>{h.paused()}},[]);const[a,t]=N.useState(!1);N.useEffect(()=>{const h=document.querySelector(".lens");let g=0,x=0,b=0,v=0;const _=.12,w=M=>{g=M.clientX,x=M.clientY};window.addEventListener("mousemove",w);let S;const E=()=>{b+=(g-b)*_,v+=(x-v)*_,h&&(h.style.transform=`
      ...
      ${a===100?"opacity-0 scale-105":"opacity-100"}`,children:[k.jsx("div",{className:"absolute inset-0 opacity-[0.08] tech-grid"}),k.jsx("div",{className:`absolute w-[500px] h-[500px] rounded-full\r
        bg-[#7af298]/10 blur-[120px]`}),k.jsxs("div",{className:"relative w-[90%] max-w-xl",children:[k.jsxs("div",{className:"flex justify-between items-center mb-6",children:[k.jsx("div",{className:"font-mono text-xs text-[#7af298]",children:"MARWANE.DEV"}),k.jsx("div",{className:"font-mono text-xs text-gray-500",children:"SYS_BOOT"})]}),k.jsxs("div",{className:"relative flex justify-center items-center h-64",children:[k.jsx("div",{className:`absolute w-52 h-52 rounded-full\r
            border border-[#7af298]/20\r
            border-t-[#7af298]\r
            ...
            border border-[#7af298]/60\r
            bg-[#7af298]/5\r
            flex items-center justify-center\r
            shadow-[0_0_50px_rgba(122,242,152,0.25)]`,children:k.jsx("div",{className:`w-10 h-10 rounded-full\r
              bg-[#7af298]\r
              shadow-[0_0_40px_#7af298]\r
              animate-pulse`})}),k.jsx("span",{className:`absolute w-2 h-2 bg-[#7af298] rounded-full\r
            top-6 left-1/2 shadow-[0_0_15px_#7af298]`}),k.jsx("span",{className:`absolute w-1.5 h-1.5 bg-[#7af298] rounded-full\r
            bottom-12 right-24 shadow-[0_0_15px_#7af298]`}),k.jsx("span",{className:`absolute w-1.5 h-1.5 bg-[#7af298] rounded-full\r
            top-16 left-24 shadow-[0_0_15px_#7af298]`})]}),k.jsxs("div",{className:"font-mono text-sm mb-3 flex justify-between",children:[k.jsx("span",{className:"text-gray-400",children:i}),k.jsxs("span",{className:"text-[#7af298]",children:[a,"%"]})]}),k.jsx("div",{className:"h-[3px] bg-white/10 overflow-hidden",children:k.jsx("div",{className:`h-full bg-[#7af298]\r
            shadow-[0_0_15px_#7af298]\r
            transition-all duration-100`,style:{width:`${a}%`}})}),k.jsxs("div",{className:"mt-5 font-mono text-[10px] text-gray-600 space-y-1",children:[k.jsxs("p",{children:[k.jsx("span",{className:"text-[#7af298]",children:"[OK]"})," ","kernel initialized"]}),k.jsxs("p",{children:[k.jsx("span",{className:"text-[#7af298]",children:"[OK]"})," ","frontend modules loaded"]}),k.jsxs("p",{children:[k.jsx("span",{className:"text-[#7af298]",children:"[OK]"})," ","portfolio data synchronized"]}),k.jsxs("p",{children:[k.jsx("span",{className:"text-[#7af298]",children:"[--]"})," ",i.toLowerCase()]})]})]})]})}const p8=`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8" />
